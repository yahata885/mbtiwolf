    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nextPlayerButton.setOnClickListener(v -> {
            ...
            if (currentPlayerIndex < playerList.size()) {
                ...
                Toast.makeText(RoleRevealActivity.this, "全員の役割確認が完了しました", Toast.LENGTH_SHORT).show();

                Intent intent = new Intent(RoleRevealActivity.this, DiscussionActivity.class);
